...
namespace AdvocaciaPPFinal.Controllers
{
    ...
    public class EmprestimosController : Controller
    {
        ...
        public EmprestimosController(AdvocaciaPPFinalContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var emprestimo = await _context.Emprestimo
                .FirstOrDefaultAsync(m => m.Id_Emprestimo == id);
            if (emprestimo == null)
            {
                return NotFound();
            }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id_Emprestimo,Valor_Emprestimo,Data_Emprestimo")] Emprestimo emprestimo)
        {
